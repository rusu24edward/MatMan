...
int TestMatrixBuilder() {
	...
	try {
		...
		Matrix combinedMatrix1 = MatrixBuilder::Combine(mat1, mat2, MatrixCombinationType::LeftRight);
		combinedMatrix1.setName("Combined Matrix 1");
		Print(combinedMatrix1, outFile);

		Matrix combinedMatrix2 = MatrixBuilder::Combine(mat2, mat1, MatrixCombinationType::LeftRight);
		combinedMatrix2.setName("Combined Matrix 2");
		Print(combinedMatrix2, outFile);

		Matrix combinedMatrix3 = MatrixBuilder::Combine(mat1, mat3, MatrixCombinationType::TopDown);
		combinedMatrix3.setName("Combined Matrix 3");
		Print(combinedMatrix3, outFile);

		Matrix combinedMatrix4 = MatrixBuilder::Combine(mat3, mat1, MatrixCombinationType::TopDown);
		combinedMatrix4.setName("Combined Matrix 4");
		Print(combinedMatrix4, outFile);

		Matrix combinedMatrix5 = MatrixBuilder::Combine(mat2, mat1(0,3,3,4), MatrixCombinationType::TopDown);
		combinedMatrix5.setName("Combined Matrix 5");
		Print(combinedMatrix5, outFile);

		Matrix combinedMatrix6 = MatrixBuilder::Combine(mat3, mat2(0,2,1,1), MatrixCombinationType::LeftRight);
		combinedMatrix6.setName("Combined Matrix 6");
		Print(combinedMatrix6, outFile);

		Matrix combinedMatrix7 = MatrixBuilder::Combine(mat1(1,3,0,5), mat3, MatrixCombinationType::LeftRight);
		combinedMatrix7.setName("Combined Matrix 7");
		Print(combinedMatrix7, outFile);

		Matrix combinedMatrix8 = MatrixBuilder::Combine(mat3(0,2,2,3), mat2, MatrixCombinationType::TopDown);
		combinedMatrix8.setName("Combined Matrix 8");
		Print(combinedMatrix8, outFile);

		Matrix combinedMatrix9 = MatrixBuilder::Combine(mat3(0,1,0,5), mat1(2,3,0,5), MatrixCombinationType::LeftRight);
		combinedMatrix9.setName("Combined Matrix 9");
		Print(combinedMatrix9, outFile);

		Matrix combinedMatrix10 = MatrixBuilder::Combine(mat1(2,2,2,2), mat2(2,2,0,0), MatrixCombinationType::TopDown);
		combinedMatrix10.setName("Combined Matrix 10");
		Print(combinedMatrix10, outFile);

		Matrix combinedMatrix11 = MatrixBuilder::Combine(mat2, mat2, MatrixCombinationType::LeftRight);
		combinedMatrix11.setName("Combined Matrix 11");
		Print(combinedMatrix11, outFile);

		Matrix combinedMatrix12 = MatrixBuilder::Combine(mat2, mat2, MatrixCombinationType::TopDown);
		combinedMatrix12.setName("Combined Matrix 12");
		Print(combinedMatrix12, outFile);

		try {
			Matrix combinedMatrix101 = MatrixBuilder::Combine(mat1, mat3, MatrixCombinationType::LeftRight);
		...
		try {
			Matrix combinedMatrix102 = MatrixBuilder::Combine(mat1, mat2, MatrixCombinationType::TopDown);
		...
		try {
			Matrix combinedMatrix103 = MatrixBuilder::Combine(mat2, mat1(0,2,3,4), MatrixCombinationType::LeftRight);
		...
		try {
			Matrix combinedMatrix104 = MatrixBuilder::Combine(mat3, mat2(0,2,1,1), MatrixCombinationType::TopDown);
		...
		try {
			Matrix combinedMatrix106 = MatrixBuilder::Combine(mat3(0,2,2,3), mat2, MatrixCombinationType::LeftRight);
		...
		try {
			Matrix combinedMatrix105 = MatrixBuilder::Combine(mat1(1,3,0,1), mat3, MatrixCombinationType::TopDown);
		...
		try {
			Matrix combinedMatrix108 = MatrixBuilder::Combine(mat1(2,2,2,2), mat2(1,2,0,0), MatrixCombinationType::LeftRight);
		...
		try {
			Matrix combinedMatrix107 = MatrixBuilder::Combine(mat3(0,1,0,4), mat1(2,3,0,5), MatrixCombinationType::TopDown);
...
int TestMatrixMultiplication() {
	...
	try{
		...
		Matrix mat9 = mat1(2,3,0,3) * -3;
		mat9.setName("Matrix 9");
		Print(mat9, outFile);

		Matrix mat10 = 0.5 * mat8;
		mat10.setName("Matrix 10");
		Print(mat10, outFile);

		Matrix mat11 = mat10 * 0;
