...
tutorial_modified.exe: tutorial.o NamedObject.o MatrixBase.o Matrix.o SubMatrix.o MatrixBuilder.o
	g++ -o tutorial.exe tutorial.o NamedObject.o MatrixBase.o Matrix.o SubMatrix.o MatrixBuilder.o
